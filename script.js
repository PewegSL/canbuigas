...
const translations = {
    es: {
        ...
        "contact": "Contacto",
        "heroTitle": "Experiencia Can Buïgas",
        ...
        "languageSupport": "Disponible en 12 idiomas",
    ...
    en: {
        ...
        "languageSupport": "Available in 12 languages",
    ...
    hi: {
        ...
        "languageSupport": "12 भाषाओं में उपलब्ध",
    ...
    fr: {
        ...
        "languageSupport": "Disponible en 12 langues",
    ...
    de: {
        ...
        "heroSubtitle": "Exklusive Aromen in une luxuriösen Atmosphäre",
        ...
        "languageSupport": "Verfügbar in 12 Sprachen",
    ...
    ar: {
        ...
        "languageSupport": "متاح بـ 12 لغة",
    ...
    ru: {
        ...
        "languageSupport": "Доступно на 12 языках",
    ...
    pt: {
        ...
        "includes": "Inclui",
        "includesDesc": "Pão artesanal, água e café ou infusão",
        ...
        "languageSupport": "Disponível em 12 idiomas",
        "reservationSuccess": "Reserva Confirmada!",
    ...
    it: {
        ...
        "languageSupport": "Disponibile in 12 lingue",
...
const menuItems = [
    {
        id: 1,
        name: "Caviar Imperial con Tostadas",
        description: "Caviar de esturión servido con tostadas artesanales y crema agria.",
        price: 85,
        category: "starters",
        image: "🥖"
    },
    {
        ...
        description: "Atún rojo de almadraba con aguacate, salsa de soja y wasabi.",
        price: 32,
        category: "starters",
        image: "🐟"
    },
    {
        ...
        description: "Foie gras de pato con reducción de Oporto y pan brioche tostado.",
        price: 28,
        category: "starters",
        image: "🦆"
    },
    {
        ...
        description: "Lubina mediterránea cocida en costra de sal marina con hierbas aromáticas.",
        price: 42,
        category: "main",
        image: "🐠"
    },
    {
        ...
        description: "Solomillo de ternera wagyu con puré de trufa negra y verduras glaseadas.",
        price: 89,
        category: "main",
        image: "🥩"
    },
    {
        id: 6,
        name: "Risotto de Bogavante",
        description: "Risotto cremoso con bogavante, azafrán y parmesano.",
        price: 38,
        category: "main",
        image: "🍚"
    },
    {
        ...
        description: "Soufflé de chocolate negro 70% con helado de vainilla bourbon.",
        price: 16,
        category: "desserts",
        image: "🍫"
    },
    {
        ...
        description: "Tarta de queso al horno con coulis de frutos rojos y crujiente de avellana.",
        price: 14,
        category: "desserts",
        image: "🍰"
    },
    {
        ...
        description: "Rioja Gran Reserva 2010 - Bodegas Marqués de Riscal.",
        price: 9,
        category: "drinks",
        image: "🍷"
    },
    {
        id: 10,
        name: "Cóctel Can Buïgas",
        description: "Ginebra, licor de saúco, zumo de lima y espuma de rosas.",
        price: 12,
        category: "drinks",
        image: "🍸"
    },
    {
        id: 11,
        name: "Agua Mineral",
        description: "Agua mineral natural o con gas - 1L.",
        price: 4,
        category: "drinks",
        image: "💧"
    },
    {
        ...
        description: "Café de especialidad con notas a chocolate y frutos secos.",
        price: 5,
        category: "drinks",
        image: "☕"
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Actualizar selector de idioma - CON EMOTICONO SIMPLE
    document.getElementById('languageSwitch').value = currentLanguage;
    document.getElementById('currentFlag').textContent = getFlagEmoji(currentLanguage);
    ...
    document.getElementById('continueBtn').addEventListener('click', function() {
        ...
        // Guardar que ya se vio el modal (opcional)
        localStorage.setItem('canbuigas_language_selected', 'true');
    });
    
    // Seleccionar automáticamente el idioma guardado
    setTimeout(() => {
        ...
        if (savedLangBtn) {
            ...
            document.getElementById('continueBtn').innerHTML = `<i class="fas fa-arrow-right"></i> Continuar con ${langName}`;
        }
    }, 100);
...
// Función para obtener emoticono de bandera según idioma
...
// Función para actualizar bandera EMOTICONO en navbar
...
function selectLanguage(lang) {
    ...
    updateFlag(lang); // Actualiza emoticono en navbar
    document.getElementById('languageSelector').style.display = 'none';
    translatePage(lang);
}
    ...
    document.querySelectorAll('[data-i18n]').forEach(element => {
        ...
        if (translations[lang] && translations[lang][key]) {
            ...
            if (element.tagName === 'INPUT' || element.tagName === 'TEXTAREA' || element.tagName === 'SELECT') {
                ...
                // Mantener la bandera y actualizar solo el texto
                const flag = element.textContent.split(' ')[0];
                element.textContent = flag + ' ' + translations[lang][key];
            } else {
...
function renderMenuItems(category) {
    ...
    // Traducir botones recién creados
    translatePage(currentLanguage);
}
...
// Función para reabrir modal de idiomas
function showLanguageModal() {
    document.getElementById('languageSelector').style.display = 'flex';
    
    // Resaltar el idioma actual
    const currentLangBtn = document.querySelector(`.language-btn[data-lang="${currentLanguage}"]`);
    if (currentLangBtn) {
        ...
        const langName = currentLangBtn.querySelector('.lang-native').textContent;
        document.getElementById('continueBtn').innerHTML = `<i class="fas fa-arrow-right"></i> Continuar con ${langName}`;
    }
}
// Actualizar el cambio de idioma en el navbar
languageSwitch.addEventListener('change', function() {
    const lang = this.value;
    const flagClass = this.options[this.selectedIndex].getAttribute('data-flag');
